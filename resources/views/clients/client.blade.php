                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                        ...
                        <div class="" id="sidebar-wrapper">
                            ...
                            <div class="list-group list-group-flush">
                                <a href="/client" class="list-group-item list-group-item-action active">Calendar</a>
                                <a href="/projects" class="list-group-item list-group-item-action ">Projects</a>
                                <a href="/add_projects" class="list-group-item list-group-item-action ">Add A Project</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row welcome_header">
                            <div class="row">
                                <div class="col-xl-12 welcome_text">
                                    <h5>Welcome!</h5>
                                    <h2 class="client_name">{{ Auth::user()->name }}</h2>
                                    <h6 class="client_address"><i class="fa fa-map" aria-hidden="true">&nbsp;&nbsp;&nbsp;</i>{{ Auth::user()->client_address }}</h6>
                                    <h6 class="client_address"><i class="fa fa-phone" aria-hidden="true">&nbsp;&nbsp;&nbsp;</i>{{ Auth::user()->phone_number }}</h6>
                                </div>
                            </div>
                        </div>
